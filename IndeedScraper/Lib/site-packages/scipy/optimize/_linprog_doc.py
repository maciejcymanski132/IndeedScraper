...
def _linprog_ip_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    1. ``sksparse.cholmod.cholesky`` (if machine_learning-sparse and SuiteSparse are
       installed)

    2. ``scipy.sparse.linalg.factorized`` (if machine_learning-umfpack and SuiteSparse
       are installed)
