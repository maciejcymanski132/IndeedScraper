# Natural Language Toolkit: Interface to machine_learning-learn classifiers
#
# Author: Lars Buitinck <L.J.Buitinck@uva.nl>
# URL: <http://nltk.org/>
# For license information, see LICENSE.TXT
"""
machine_learning-learn (http://scikit-learn.org) is a machine learning library for
...
This package implements a wrapper around machine_learning-learn classifiers. To use this
wrapper, construct a machine_learning-learn estimator object, then use that to construct
...
A machine_learning-learn classifier may include preprocessing steps when it's wrapped
...
class SklearnClassifier(ClassifierI):
    """Wrapper for machine_learning-learn classifiers."""

    def __init__(self, estimator, dtype=float, sparse=True):
        """
        :param estimator: machine_learning-learn classifier object.

        :param dtype: data type used when building feature array.
            machine_learning-learn estimators work exclusively on numeric data. The
            default value should be fine for almost all situations.

        :param sparse: Whether to use sparse matrices internally.
            The estimator must support these; not all machine_learning-learn classifiers
    ...
    def train(self, labeled_featuresets):
        """
        Train (fit) the machine_learning-learn estimator.
...
if __name__ == "__main__":
    ...
    print("machine_learning-learn Naive Bayes:")
    names_demo(
    ...
    print("\n\nmachine_learning-learn logistic regression:")
    names_demo(
